...
rem set "CATALINA_HOME=C:\Program Files\VitalSoft\core\apache-tomcat-8.0.30"
rem set "CATALINA_BASE=C:\Program Files\VitalSoft\core\apache-tomcat-8.0.30"
...
set "JRE_HOME=%install_path%\core\jre1.8.0_72"
...
set SERVICE_NAME=Vitalsoft
set DISPLAYNAME=Vitalsoft
